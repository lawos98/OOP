...
/**
 * Initializes the Utilities.MapVisualizer with an instance of map to visualize.
 * @param map
 */ {
    /**
...
//      ==================================================
        val (left, bottom) = Pair(lowerLeft.x,lowerLeft.y)
        val (right, top) = Pair(upperRight.x,upperRight.y)
//      ==================================================
